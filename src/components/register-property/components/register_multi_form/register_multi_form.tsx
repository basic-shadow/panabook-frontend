...
const mapStepToText = {
  ...
  5: "Загружайте фотографии высокого разрешения которые представляют ваш объект размещения. Эти фотографии будут показываться на странице вашего объекта на сайте Mybooking.uz.",
